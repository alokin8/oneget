...
namespace Microsoft.OneGet.Core.Extensions {
    ...
    internal static class DelegateExtensions {
        ...
        internal static bool IsDelegateAssignableFromMethod(this Type delegateType, MethodInfo methodInfo) {
            ...
            //
            // I wanted to have the Invoke delegate type declared independently in plugins
            ...
            // when it was just easier and alias Invoke to Func<string, IEnumerable<object>, object>
            //
