...
namespace Microsoft.OneGet.Core.Api {
    ...
    public class InvokableDispatcher : MarshalByRefObject, IDisposable, IEnumerable<Delegate>, IInvokable {
        ...
        // private Dictionary<string, Delegate> _callbacks = new Dictionary<string, Delegate>(StringComparer.OrdinalIgnoreCase);
        ...
        public void Add<T>(T dlg) {
            ...
            _functions.AddOrSet(typeof (T).Name, new Call{ Delegate = dlg as Delegate, Invokable = ((Invokable)typeof (T).CreateWrappedProxy(dlg as Delegate))});
        }
    ...
    // <summary>
    //     Is the provider of all other callbacks to the plugins.
    ...
    #region declare collection-callbacks
    ...
    // In .NET and Powershell, the plugin model already transparently marshals IEnumerable<>
