...
namespace Microsoft.OneGet.Core.Api {
    ...
    internal class Bootstrapper {
        ...
        private static string[] NuGetPackageDownloadLocations = new[] {
        ...
        private static string[] NuGetExeDownloadLocations = new[] {
        ...
        private string ExePath {
            get {
                ...
                Event<Verbose>.Raise("MissingDependency", "NuGet not in place. Attempting to download");
                ...
                // todo:get the right text here.
                    ...
                    foreach (var location in NuGetPackageDownloadLocations) {
                        ...
                        if (downloadedFile != null && FilesystemExtensions.FileExists(downloadedFile)) {
                            // unpack this file
                            try {
        ...
        private string DllPath {
            get {
                ...
                if (exe == null || !FilesystemExtensions.FileExists(exe)) {
                    return null;
                }
