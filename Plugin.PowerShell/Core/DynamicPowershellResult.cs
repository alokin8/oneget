...
namespace Microsoft.OneGet.Plugin.PowerShell.Core {
    using System;
    ...
    internal class DynamicPowershellResult : IDisposable, IEnumerable<object> {
        internal ManualResetEvent CompletedEvent = new ManualResetEvent(false);
        internal BlockingCollection<ErrorRecord> Errors = new BlockingCollection<ErrorRecord>();
